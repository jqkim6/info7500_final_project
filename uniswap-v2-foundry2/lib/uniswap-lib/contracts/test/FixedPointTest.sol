...
contract FixedPointTest {
    function encode(uint112 x) external view returns (FixedPoint.uq112x112 memory) {
        return FixedPoint.encode(x);
    }

    function encode144(uint144 x) external view returns (FixedPoint.uq144x112 memory) {
        return FixedPoint.encode144(x);
    }

    function decode(FixedPoint.uq112x112 calldata self) external view returns (uint112) {
        return FixedPoint.decode(self);
    }

    function decode144(FixedPoint.uq144x112 calldata self) external view returns (uint144) {
        return FixedPoint.decode144(self);
    }

    function mul(FixedPoint.uq112x112 calldata self, uint256 y) external view returns (FixedPoint.uq144x112 memory) {
        return FixedPoint.mul(self, y);
    }

    function muli(FixedPoint.uq112x112 calldata self, int256 y) external view returns (int256) {
    ...
    function fraction(uint112 numerator, uint112 denominator) external view returns (FixedPoint.uq112x112 memory) {
        return FixedPoint.fraction(numerator, denominator);
    }

    function reciprocal(FixedPoint.uq112x112 calldata self) external view returns (FixedPoint.uq112x112 memory) {
        return FixedPoint.reciprocal(self);
    }

    function sqrt(FixedPoint.uq112x112 calldata self) external view returns (FixedPoint.uq112x112 memory) {
